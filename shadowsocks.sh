...
#   Author: Cyril Wong <hi@hxzo.com>                              #
#   Thanks: @Teddysun <i@teddysun.com>                            #
#   Intro:  https://hxzo.com                                      #
#=================================================================#
...
echo "# Intro: https://hxzo.com                                   #"
echo "# Author: Cyril Wong <hi@hxzo.com>                          #"
...
download_files(){
    ...
    if check_sys packageManager yum; then
        if ! wget --no-check-certificate https://raw.githubusercontent.com/ikym/Shadowsocks/master/shadowsocks -O /etc/init.d/shadowsocks; then
            echo -e "[${red}Error${plain}] Failed to download shadowsocks chkconfig file!"
            exit 1
        fi
    elif check_sys packageManager apt; then
        if ! wget --no-check-certificate https://raw.githubusercontent.com/ikym/Shadowsocks/master/shadowsocks-debian -O /etc/init.d/shadowsocks; then
            echo -e "[${red}Error${plain}] Failed to download shadowsocks chkconfig file!"
            exit 1
        fi
    fi
...
install(){
    ...
    echo
    echo "Welcome to visit:https://hxzo.com"
    echo "Enjoy it!"
    echo
}
